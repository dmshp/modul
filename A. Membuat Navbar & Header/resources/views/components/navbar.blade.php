            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <x-nav-link-web href="/" :active="request()->is('/')">Home</x-nav-link-web>
                        <x-nav-link-web href="blog" :active="request()->is('blog')">Blog</x-nav-link-web>
                        <x-nav-link-web href="contact" :active="request()->is('contact')">Contact</x-nav-link-web>
                        <x-nav-link-web href="about" :active="request()->is('about')">About</x-nav-link-web>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
